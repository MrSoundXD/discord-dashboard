...
function App() {
  ...
  const fetchUserData = async (discordId) => {
    ...
    } catch (e) { console.error("Login fout", e); }
  };
  ...
  const fetchMcStats = async (ip) => {
    ...
    try {
      ...
      setMcStats(res.data);
    } catch (e) { console.error("MC Error"); }
  };
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <p className="text-gray-400 mb-10 text-xl">Beheer jouw Minecraft status</p>
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4 bg-[#222] p-4 border-l-4 border-[#FFAA00] shadow-lg">
                    ...
                    />
                    <div>
                        <div className="text-gray-400 text-sm">INGELOGD ALS</div>
                        <div className="text-2xl font-bold text-[#FFAA00]">{user.username}</div>
                    </div>
                </div>

                <div className="mc-panel p-6">
                    <h2 className="text-3xl mb-4 border-b-2 border-[#888] pb-2">⚙️ Instellingen</h2>
                    ...
                    <input 
                        ...
                        placeholder="bijv. play.hypixel.net"
                    />
                ...
                <div className="relative z-10 p-6 flex flex-col items-center justify-center h-full text-center space-y-4">
                    {mcStats.online ? (
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-white mt-2 text-lg">Geen verbinding met {inputIp}</p>
                        </div>
                    )}
                </div>
            </div>
      ...
      <div className="mt-12 text-gray-600">Portfolio Project 2025</div>
    </div>
  );
}
